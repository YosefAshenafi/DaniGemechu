              ...
              <div className="space-y-16">
                 ...
                 <div className="pt-10 border-t border-gray-100 flex items-center gap-10">
                    ...
                    <div className="flex gap-6">
                       <a href="https://web.facebook.com/dgemechu" target="_blank" className="w-12 h-12 rounded-full border border-gray-200 flex items-center justify-center text-primary-light hover:text-accent hover:border-accent transition-all hover:bg-accent/5">
                          <FacebookIcon />
                       </a>
                       ...
                       <a href="https://www.tiktok.com/@danielgemechulaw" target="_blank" className="flex items-center gap-2 font-bold text-sm text-primary hover:text-accent transition-colors">
                          <span className="p-1 px-3 bg-primary text-white rounded-full text-[10px]">TikTok</span> @danielgemechulaw
                       </a>
                    </div>
                 </div>
              </div>
