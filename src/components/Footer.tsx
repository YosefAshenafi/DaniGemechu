      ...
      <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12">
        <div className="space-y-6">
          ...
          <div className="flex space-x-5">
            <Link href="https://web.facebook.com/dgemechu" target="_blank">
              <FacebookIcon />
            </Link>
            <Link href="https://www.linkedin.com/in/daniel-gemechu-3133487a/" target="_blank">
              <LinkedinIcon />
            </Link>
            <Link href="https://www.tiktok.com/@danielgemechulaw" target="_blank" className="text-gray-400 hover:text-white transition-colors flex items-center gap-1.5 text-sm font-semibold">
               <span className="bg-white/10 p-1 rounded-sm">TikTok</span>
            </Link>
          </div>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm text-gray-300">
            <li className="flex items-center space-x-3 group">
              ...
              <span className="group-hover:text-accent transition-colors">+251 (0) 911 234 567</span>
            </li>
            <li className="flex items-center space-x-3 group">
              <div className="w-8 h-8 bg-white/5 rounded-full flex items-center justify-center group-hover:bg-accent/20 transition-all">
                <Mail size={16} className="text-accent" />
              </div>
              <span className="group-hover:text-accent transition-colors">daniel.gemechu@law.et</span>
            </li>
            <li className="flex items-start space-x-3 group">
              ...
              <span className="group-hover:text-accent transition-colors">Bole Area, Addis Ababa, Ethiopia</span>
            </li>
          </ul>
        </div>
      </div>
